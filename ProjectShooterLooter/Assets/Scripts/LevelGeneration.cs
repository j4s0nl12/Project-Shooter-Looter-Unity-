...
public class LevelGeneration : MonoBehaviour {
	...
	void CreateRooms(){
		//setup
		rooms = new Room_Tutorial[gridSizeX * 2,gridSizeY * 2];
		rooms[gridSizeX,gridSizeY] = new Room_Tutorial(Vector2.zero, 1);
		...
		for (int i =0; i < numberOfRooms -1; i++){
			...
			//finalize position
			rooms[(int) checkPos.x + gridSizeX, (int) checkPos.y + gridSizeY] = new Room_Tutorial(checkPos, 0);
	...
	void DrawMap(){
		foreach (Room_Tutorial room in rooms){
			if (room == null){
